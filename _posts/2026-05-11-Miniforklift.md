...
## Millennial
<img src="{{ site.baseurl }}/assets/img/PhantomII/NRC_Design_Diagram.jpg" class="img-wrap-left" alt="Diagram">
<p>
  Your technical description for the PhantomII project goes here. 
  By using the HTML tag directly, you bypass the Markdown parser's 
  tendency to wrap images in block elements that prevent floating.
</p>
